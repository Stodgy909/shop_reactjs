...
function Shop(){
    ...
    //Hooks de estado para almacenar la información de los productos y caegorías
    ...
    //Hook de efecto pra solicitar los datos hasta que se hayan obtenido todos los productos vacíos
    useEffect(() =>{
